...
// Portiert aus Razor CE (Razor/Core/Dress.cs) — Phase 2d.
// NEU: UndressAll() ist aus Razor CE HotKeys/Undress.cs (OnUndressAll)
// hierher gezogen (das HotKey-System kommt erst in Phase 3); genutzt von
// UnDressAction (Layer 0).
...
namespace Assistant.Core
{
    public static class Dress
    {
        ...
        /// <summary>Razor CE: HotKeys/Undress.cs OnUndressAll.</summary>
