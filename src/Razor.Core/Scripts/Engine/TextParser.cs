...
// Portiert aus Razor CE (Razor/Scripts/Engine/TextParser.cs) fuer den
// UOSagas-Razor-Port. Reiner Tokenizer (Leerzeichen-Delimiter, '/"-Quotes),
// keine externen Abhaengigkeiten — 1:1 uebernommen.
